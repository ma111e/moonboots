...
It currently implements multiple shellcode loading techniques in pure Go¹ and can be easily extended by adding new loader plugins.
...
Flags:
  ...
  -m, --method string              Method to use to load the shellcode. Available: [createfiber createthread earlybird etwpcreate createprocess createthreadnative syscall createremotethread queueapc createremotethreadnative dirtyvanity rtlcreateuserthread uuid] (default "createthread")
...
¹: Most are based on [Ne0nd0g](https://github.com/Ne0nd0g/go-shellcode)'s work
